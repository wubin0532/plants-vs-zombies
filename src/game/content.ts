...
export const plants: PlantDef[] = [
  p("arc", "电弧花", 225, "electric", 8, "#77dfed",
    "每 1.4 秒电击前方单体，伤害 40。命中冰系目标时消耗其冰控（同一目标 4 秒内仅触发一次），追加 100 伤害，并向附近至多 3 个敌人各传导 40 伤害。", { damage: 40, interval: 1.4 }),
  p(
    "pea",
    "豌豆射手",
    100,
...
export const zombies: ZombieDef[] = [
  ...
  z("dancer", "舞王僵尸", 500, 10, 0, "定期召唤伴舞僵尸，最多同时存在 4 个伴舞。", "优先消灭舞王，伴舞就不会继续出现。", ["squash", "cherry", "hypno"]),
  z("backup", "伴舞僵尸", 200, 10, 0, "跟随舞王从附近加入战斗。", "挡住舞王，伴舞就不再增援。"),
