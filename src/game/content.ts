...
export const zombies: ZombieDef[] = [
  ...
  z("pole", "撑杆僵尸", 400, 27, 0, "跨过遇到的第一株矮植物。"),
  z("bucket", "铁桶僵尸", 260, 10, 1350, "铁桶非常坚固，但会被磁力菇吸走。"),
  ...
  z("football", "橄榄球僵尸", 300, 29, 1700, "移动快，护甲也很厚。"),
