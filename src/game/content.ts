...
const z = (
  ...
  tip: string,
  color = "#8faaa0",
): ZombieDef => ({ id, name, hp, speed, armor, desc, tip, color });
export const zombies: ZombieDef[] = [
  ...
  z("pole", "撑杆僵尸", 400, 27, 0, "跨过遇到的第一株矮植物。", "只会跨一次；高坚果能直接拦下这一跳。"),
  z("bucket", "铁桶僵尸", 260, 10, 1350, "铁桶非常坚固，但会被磁力菇吸走。", "磁力菇能吸走铁桶，让它立刻变脆。"),
  ...
  z("football", "橄榄球僵尸", 300, 29, 1700, "移动快，护甲也很厚。", "寒冰射手减速，磁力菇吸走护甲。"),
  z("dancer", "舞王僵尸", 500, 12, 0, "定期召唤伴舞僵尸。", "优先消灭舞王，伴舞就不会继续出现。"),
  z("backup", "伴舞僵尸", 200, 12, 0, "跟随舞王从附近加入战斗。", "挡住舞王，伴舞就不再增援。"),
  z("ducky", "鸭子救生圈僵尸", 200, 11, 0, "乘着泳圈进入水路。", "会在水路出现，别忘了在睡莲上布置火力。"),
  z("snorkel", "潜水僵尸", 200, 15, 0, "潜水时躲避普通直射攻击。", "投手类植物能直接打中潜水的它。"),
  z("zomboni", "冰车僵尸", 1650, 16, 0, "碾压植物并留下不能种植的冰道。", "地刺能扎破冰车；火爆辣椒可以清除冰道。"),
  z("bobsled", "雪橇僵尸小队", 800, 25, 0, "沿着冰道快速推进。", "清除冰道后，雪橇小队就失去了速度。"),
  z("dolphin", "海豚骑士僵尸", 400, 34, 0, "快速游动，跳过第一株矮植物。", "高坚果能拦住它的跳跃。"),
  z("jack", "玩偶匣僵尸", 340, 18, 0, "随身的盒子可能爆炸并摧毁附近植物。", "尽快远程消灭，别让它走进植物阵中。"),
  z("balloon", "气球僵尸", 200, 12, 0, "飞过普通植物，需要防空能力应对。", "仙人掌能击落气球，三叶草可以直接吹走。"),
  z("digger", "矿工僵尸", 270, 25, 0, "钻到庭院左侧后向右啃食。", "裂荚射手能向后攻击；磁力菇能吸走矿镐。"),
  z("pogo", "跳跳僵尸", 400, 22, 0, "不断跳过矮植物，磁力菇能吸走跳杆。", "磁力菇吸走跳杆后就只能步行。"),
  z("yeti", "雪人僵尸", 1350, 14, 0, "只在通关重玩时出现，停留后逃离。", "停留片刻就会逃跑，集中火力速战速决。"),
  z("bungee", "蹦极僵尸", 450, 0, 0, "从空中落下，偷走一株植物。", "叶子保护伞能挡下它的偷袭。"),
  z("catapult", "投石车僵尸", 850, 11, 0, "远处投篮，接近后碾压植物。", "叶子保护伞挡篮球；地刺能扎破它的车。"),
  z("garg", "巨人僵尸", 3800, 10, 0, "砸毁植物，半血时抛出小鬼。", "半血时会抛出小鬼，留好樱桃炸弹应对落点。"),
  z("imp", "小鬼僵尸", 200, 20, 0, "体型小，移动迅速。", "会被抛到防线中段，提前在那里布置火力。"),
  z("boss", "僵王博士", 24000, 0, 0, "召唤僵尸、砸击并发射冰火球。", "寒冰菇熄灭火球，火爆辣椒融化冰球。"),
  z(
    "ladder",
    "扶梯僵尸",
    600,
