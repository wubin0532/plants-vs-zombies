...
const z = (
  ...
  desc: string,
  color = "#8faaa0",
): ZombieDef => ({ id, name, hp, speed, armor, desc, color });
export const zombies: ZombieDef[] = [
  z("basic", "普通僵尸", 200, 10, 0, "慢慢走来，啃食面前的植物。"),
  z("flag", "旗帜僵尸", 200, 13, 0, "举旗带领一大波僵尸进攻。"),
  z("cone", "路障僵尸", 200, 10, 370, "路障提供额外保护。"),
  z("pole", "撑杆僵尸", 340, 23, 0, "跨过遇到的第一株矮植物。"),
  z("bucket", "铁桶僵尸", 200, 10, 1100, "铁桶非常坚固，但会被磁力菇吸走。"),
  z("paper", "读报僵尸", 200, 10, 150, "报纸破掉后，会愤怒地加速。"),
  z(
    "screen",
    "铁栅门僵尸",
    200,
  ...
  z("football", "橄榄球僵尸", 200, 25, 1400, "移动快，护甲也很厚。"),
  z("dancer", "舞王僵尸", 500, 12, 0, "定期召唤伴舞僵尸。"),
  z("backup", "伴舞僵尸", 200, 12, 0, "跟随舞王从附近加入战斗。"),
  z("ducky", "鸭子救生圈僵尸", 200, 11, 0, "乘着泳圈进入水路。"),
  z("snorkel", "潜水僵尸", 200, 15, 0, "潜水时躲避普通直射攻击。"),
  z("zomboni", "冰车僵尸", 1350, 16, 0, "碾压植物并留下不能种植的冰道。"),
  z("bobsled", "雪橇僵尸小队", 800, 25, 0, "沿着冰道快速推进。"),
  z("dolphin", "海豚骑士僵尸", 340, 30, 0, "快速游动，跳过第一株矮植物。"),
  z("jack", "玩偶匣僵尸", 340, 18, 0, "随身的盒子可能爆炸并摧毁附近植物。"),
  z("balloon", "气球僵尸", 200, 12, 0, "飞过普通植物，需要防空能力应对。"),
  z("digger", "矿工僵尸", 270, 25, 0, "钻到庭院左侧后向右啃食。"),
  z("pogo", "跳跳僵尸", 340, 19, 0, "不断跳过矮植物，磁力菇能吸走跳杆。"),
  z("yeti", "雪人僵尸", 1350, 14, 0, "只在通关重玩时出现，停留后逃离。"),
  z("bungee", "蹦极僵尸", 450, 0, 0, "从空中落下，偷走一株植物。"),
  z("catapult", "投石车僵尸", 850, 11, 0, "远处投篮，接近后碾压植物。"),
  z("garg", "巨人僵尸", 3000, 10, 0, "砸毁植物，半血时抛出小鬼。"),
  z("imp", "小鬼僵尸", 200, 20, 0, "体型小，移动迅速。"),
  z("boss", "僵王博士", 24000, 0, 0, "召唤僵尸、砸击并发射冰火球。"),
  z(
    "ladder",
    "扶梯僵尸",
    500,
